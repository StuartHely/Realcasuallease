...
export const adminRouter = router({
    ...
    importAllData: adminProcedure
      .input(z.object({
        exportedAt: z.string(),
        tables: z.object({
          owners: z.array(z.record(z.string(), z.unknown())).optional(),
          users: z.array(z.record(z.string(), z.unknown())).optional(),
          shoppingCentres: z.array(z.record(z.string(), z.unknown())).optional(),
          floorLevels: z.array(z.record(z.string(), z.unknown())).optional(),
          sites: z.array(z.record(z.string(), z.unknown())).optional(),
          usageCategories: z.array(z.record(z.string(), z.unknown())).optional(),
          siteUsageCategories: z.array(z.record(z.string(), z.unknown())).optional(),
          thirdLineCategories: z.array(z.record(z.string(), z.unknown())).optional(),
          thirdLineIncome: z.array(z.record(z.string(), z.unknown())).optional(),
          vacantShops: z.array(z.record(z.string(), z.unknown())).optional(),
          seasonalRates: z.array(z.record(z.string(), z.unknown())).optional(),
          systemConfig: z.array(z.record(z.string(), z.unknown())).optional(),
