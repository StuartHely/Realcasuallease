...
export default function ThirdLineBookings() {
  ...
  const { data: allBookings } = trpc.thirdLineBookings.list.useQuery({
    status: undefined,
  });
  ...
  const filteredBookings = useMemo(() => {
    ...
    return bookings.filter((booking) => {
      ...
      const categoryName = booking.categoryName?.toLowerCase() || "";
  ...
  const approveMutation = trpc.thirdLineBookings.updateStatus.useMutation({
    onSuccess: () => {
  ...
  const rejectMutation = trpc.thirdLineBookings.updateStatus.useMutation({
    onSuccess: () => {
      ...
      <div className="space-y-6">
        <div className="flex items-start justify-between">
          <div>
            <h1 className="text-3xl font-bold flex items-center gap-3">
              ...
              3rdL Booking Management
            </h1>
            <p className="text-muted-foreground mt-2">
              Review and manage Third Line Income booking requests
            </p>
          </div>
        ...
        <Tabs value={selectedStatus} onValueChange={(v) => setSelectedStatus(v as BookingStatus)}>
          ...
          <TabsContent value={selectedStatus} className="mt-6">
            <Card>
              <CardHeader>
                <CardTitle>{selectedStatus === "all" ? "All" : selectedStatus.charAt(0).toUpperCase() + selectedStatus.slice(1)} 3rdL Bookings</CardTitle>
                <CardDescription>
                          ...
                          <TableRow key={booking.id}>
                            ...
                            <TableCell>
                              <div className="flex items-center gap-2">
                                ...
                                <div>
                                  <div className="font-medium">{booking.assetName || `Asset #${booking.thirdLineIncomeId}`}</div>
                            ...
                            <TableCell>
                              <Badge variant="outline" className="bg-purple-50 text-purple-700 border-purple-200">
                                {booking.categoryName || "Uncategorized"}
                              </Badge>
                            </TableCell>
                            <TableCell>
                              <div className="flex items-center gap-2">
        ...
        <Dialog open={approveDialogOpen} onOpenChange={setApproveDialogOpen}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Are you sure you want to approve this Third Line Income booking? The customer will be notified.
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
